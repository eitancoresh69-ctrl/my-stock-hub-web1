# realtime_data.py — נתונים בזמן אמת: Finnhub + Fear & Greed + מדדי מאקרו
# ═══════════════════════════════════════════════════════════════════════════════
# הרשמה חינמית ל-API Key: https://finnhub.io  (0 דולר, 60 קריאות/דקה)
# הכנס את ה-KEY שלך בשורה: FINNHUB_API_KEY = "YOUR_KEY_HERE"
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 1: Finnhub — מחירים חיים (במקום yfinance עם עיכוב 15 דקות)
# ═══════════════════════════════════════════════════════════════════════════════
...
def get_live_price_smart(symbol: str) -> float | None:
    """
    מחזיר מחיר חי — מנסה Finnhub קודם, נפילה ל-yfinance.
    זה מחליף את _get_live_price() ב-simulator.py
    """
    # ניסיון Finnhub (מהיר, חי)

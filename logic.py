# logic.py - WORKING VERSION עם Integration מ-realtime_data
...
def _fetch_single_symbol(symbol: str) -> dict:
    try:
        # קבל מחיר חי מ-realtime_data אם זמין
        live_price = None
        ...
        # Use live price if available, else from history

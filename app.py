# app.py — Investment Hub Elite 2026 — גרסה סופית + משתמשים + מפוצל
...
# ══ 27: מדריך + סטטוס סוכנים (מפוצל לקובץ חיצוני) ══════════════════════════════
with tabs[27]:
